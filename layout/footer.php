...
<hr>
	...
	Copyright © 2012-2015 Educacion.be .::. Educacion OnLIne | Design by Hilario Guzman - Development by Educacion.be - cursos.educacion.be
...
<div class="formulario">
		    		<form action="/hola" method="POST" id="formulario">
		    			<label id="inscripcion">Inscríbete y te mantendremos informado</label>
		    			<div class="borde">
