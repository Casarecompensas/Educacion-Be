...
function educacionbe_process_css($css, $theme) {
    ...
    $css = educacionbe_set_customcss($css, $customcss);
    
    return $css;
}

function educacionbe_set_menubackcolor($css, $menubackcolor) {
...
function educacionbe_set_menuhovercolor($css, $menuhovercolor) {
...
function educacionbe_set_backcolor($css, $backcolor) {
